...
import { ListTodo, PenTool, CheckCircle } from "lucide-react";

const navItems = [
  { href: "/content-engine/queue", label: "Queue", icon: ListTodo },
  { href: "/content-engine/editor", label: "Editor", icon: PenTool },
  { href: "/content-engine/published", label: "Published", icon: CheckCircle },
];
...
export function ContentEngineShell({ children }: ContentEngineShellProps) {
