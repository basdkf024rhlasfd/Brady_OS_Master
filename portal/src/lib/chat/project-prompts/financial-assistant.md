...
> **Canonical source:** Notion page `34bed43b-89c5-8113-8c76-ef579877e240`, Section 0.
> If you have Notion MCP access, fetch that page first — Section 0 has complete instructions.
> If not, the KB files in context are current as of the last Finn run.
> The GUARDRAILS block below is regenerated by Finn on each full/weekly run — edit guardrails in Notion, not here.
...
<!-- GUARDRAILS-START — regenerated by Finn Phase 4 from Notion Section 0 -->
GUARDRAILS:
...
- If a number isn't in your KB, say so plainly — do not guess or extrapolate.
- Cite figures with source and date. Flag any source >14 days old.
<!-- GUARDRAILS-END -->
