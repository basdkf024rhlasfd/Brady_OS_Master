...
Per-kid extracurricular activities with schedules, locations, and logistics.
...
- **Piano**
  - 10 min daily practice (learning)
  - Lessons: TBD (or self-guided?)
- **Upcoming**: Olivia's 9th birthday pool party — April 25, 12:00-1:30 PM at Bentonville Community Center Pool
...
- **Piano** (self-teaching via YouTube)
  - Practice: Self-directed
- **Triathlon Training**
  - Training with Harper
  - Schedule: TBD (confirm with Brady)
- **TREC Boomtown** (school project)
  - Mrs. Whitfield's 3rd grade class
  - Needs: shoe boxes (all sizes) and empty paper towel/toilet paper rolls

## Upcoming Events

- **April 20**: Overtones Concert — Arend Arts Center, 7:00 PM (Lily)
- **April 25**: Olivia's 9th Birthday Party — Pool, 12:00-1:30 PM (Isla)

## Notes

- Choir concert dates often announced a few weeks out — morning sweep catches emails from Terry Hicks
- Luke's BJJ schedule confirmed from Google Calendar recurring events
