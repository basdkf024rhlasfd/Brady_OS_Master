...
**Income regime (updated 2026-07-18):** Brady started **1915 South (W-2)** on 5/31/2026 — base ~$8,750/mo take-home ($150K/yr gross) + quarterly EBT bonus. **Floor planning case (locked 2026-07-18): $60K/qtr = $240K/yr gross** — Brady's own estimate, independently confirmed by actual Q2 EBT pace ($4.0M/qtr × 1.5%). Supersedes the earlier $300K/yr assumption. Goal case ($125K/qtr = $500K/yr) tracked as upside. This **replaces** the consulting/self-employed transition model: withholding is automatic, no 30% tax-reserve bucket, employer benefits (pre-tax ~$1,014/mo) **replace COBRA** ($3,000/mo, gone). Karissa is **home** (discharged 6/30) — the two-household Utah cost structure is collapsing to one. Travel is employer-reimbursed. HELOC draws (Arvest) are **debt, never income**.
