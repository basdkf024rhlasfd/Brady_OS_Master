...
- Agent template: `custom-built-agents/_template.md`
- Agent operational files (SKILL.md, README.md, STATUS-TEMPLATE.md) stay with the agent profile in `custom-built-agents/`, not in `3-reference/skills/`
- DiCaprio is the recon agent (reports to Claudine)
...
- Genie is the heritage / genealogy project intelligence agent (Cycle-horizon coach across all of Brady's ancestral branches). Owns the Clark/Monacan project (paternal grandmother) and the Donahoe-Bull-Dean project (maternal grandmother); absorbs new branches as Brady opens them. Three modes: Synthesis / Primary-Source Hunt / Archive-Action-Driver. Calls the genealogy-research engine skill (`3-reference/skills/genealogy-research/SKILL.md`) for new-branch runs. Whitepaper renders are HARD GATE — Brady reviews .md before HTML/PDF. Files: `genie.md`, `genie-SKILL.md`. Trigger: "ask genie", "genie [question]", "run genie on [branch]".
