...
1. **"Which company do you want to focus on first — PropMatic, Saivory, or Jelly Capital?"**
   - This sets the default context for the session. All three are loaded, but focus matters.

2. **"What's the one thing you wish your target market understood about [company]?"**
...
- Mark can connect his own account or use Brady's
- Enables: social graphics, presentation decks, visual content

### Step 5: Notion (2 min, optional)
- Mark can connect his own workspace or use Brady's
...
- "Plan my Q3 content strategy across all three companies"
