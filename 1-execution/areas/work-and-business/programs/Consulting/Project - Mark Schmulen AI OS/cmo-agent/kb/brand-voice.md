...
- Writing style: formal vs. casual, sentence length, paragraph structure
- Vocabulary: words Mark uses often, words he avoids
- Tone: authoritative, conversational, technical, storytelling-driven
- Humor usage: how much, what kind
- Communicators Mark admires (models to reference)
- Specific phrases or frameworks Mark repeats
