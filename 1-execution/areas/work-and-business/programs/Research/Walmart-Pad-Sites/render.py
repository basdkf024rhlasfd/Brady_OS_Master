#!/usr/bin/env python3
"""Render the Walmart pad-sites deep-research report from markdown to styled HTML (dark) + PDF (light).
...
SRC = HERE / "walmart-pad-sites-deep-research-2026-07-23.md"
OUT_DARK = HERE / "walmart-pad-sites-deep-research-2026-07-23.html"
OUT_LIGHT = HERE / "walmart-pad-sites-deep-research-2026-07-23-light.html"
OUT_PDF = HERE / "walmart-pad-sites-deep-research-2026-07-23.pdf"

TITLE = "Pad Sites on Walmart Properties"
SUBTITLE = "Where to Find Them, What's Available, What They Cost, and Where the Traps Are"
PREPARED_FOR = "Brady Smallwood — mception.ai consulting practice"
...
def render_cover() -> str:
    return f"""
    <section class="cover">
      <div class="cover-label">MCEPTION.AI · DEEP RESEARCH · COMMERCIAL REAL ESTATE</div>
      ...
      <div class="cover-meta">
        ...
        <div>DEPTH · <span>DEEP · 9 VERIFIED TRACKS + 3 GAP-FILL PASSES · 90 CITED SOURCES</span></div>
      </div>
    </section>
    """
...
CSS = r"""
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .body a { color: var(--blue); text-decoration: none; word-break: break-all; }
  ...
  /* Sources table: smaller type, tight URLs */
  .body h2:last-of-type ~ table { font-size: 8pt; }
  ...
  @media print {
    ...
    .body blockquote { page-break-inside: avoid; }
  }
"""
